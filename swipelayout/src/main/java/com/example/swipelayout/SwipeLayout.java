...
public class SwipeLayout extends RelativeLayout {
            ...
            if (dragRight != null) {
                switch (typeSwipeRight) {
                    case DRAG:
                        ...
                        break;
                    case HARMONIC:
                        RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams(-(int) tX, ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    private void setWidthRight() {
        if (dragRight != null) {
            RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams(-(int) minV, dragRight.getHeight());
            rl.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
            dragRight.setLayoutParams(rl);
        }
    }
